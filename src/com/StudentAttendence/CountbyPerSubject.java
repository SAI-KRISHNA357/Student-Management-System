...
/**
 * Servlet implementation class CountbyPerSubject
 */
@WebServlet("/CountbyPerSubject")
public class CountbyPerSubject extends HttpServlet {
	private static final long serialVersionUID = 1L;
       Dao daoObject;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CountbyPerSubject() {
        daoObject = new Dao();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int val = 0;
		val = daoObject.CountbyPerSubject(studentObject);
		request.setAttribute("count", val);
		request.setAttribute("Subject", subject);
		RequestDispatcher rd=request.getRequestDispatcher("/CountbyPerSubjectResult.jsp");
