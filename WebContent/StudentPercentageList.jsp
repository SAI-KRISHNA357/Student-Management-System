...
<title>Student Percentage List</title>
<meta charset="utf-8">
...
<h2 style="text-align:center;color: #ff9900"><b>List</b></h2><hr style="width:20%; height:2px;background-color:gray">
<table align="center" style="text-align:center" border="1">
  <form id = "form" action="StudentPercentageList" method="post">
