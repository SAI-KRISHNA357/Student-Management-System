...
<h2 style="text-align:center;color:yellow"><b>CountBySubject </b></h2><hr style="width:20%; height:2px;background-color:gray">
<table align="center" style="text-align:center" border="1">
 <form id = "form" action="CountbyPerSubject" method="post">
