...
<nav class="navbar navbar-inverse">
 ...
 <a class="navbar-brand"><div class="text-danger"> STUDENT MANAGEMENT SYSTEM </div></a>
    ...
    <li class="nav-item active">
        <a class="nav-link" style="color:red"  href="StudentRegister.jsp">Enterdata</a>
    </li> 
...
<h2 style="text-align:center;color:lightblue"><b>Enter Data </b></h2><hr style="width:20%; height:2px;background-color:gray">
<table align="center" style="text-align:center" border="1">
  <form id = "form" action="StudentAttendenceRegister" method="post">
   
<tr>
<td>
<input id='uname' type='hidden' value=<%= val.getUsername() %> name='Lname' required>
</td>
</tr>
...
<label style="color:white" for="branch">BRANCH:</label><br/>
 <select name="branch" id="branch" onClick ="Subject(this.value);" required>	
    ...
    <option class="MECH" value="MECH">MECH</option>
