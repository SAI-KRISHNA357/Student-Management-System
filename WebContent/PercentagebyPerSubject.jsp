...
<title>Count by Per Subject</title>
<meta charset="utf-8">
...
<a class="navbar-brand"><div class="text-danger"> STUDENT MANAGEMENT SYSTEM </div></a>
    ...
    <ul class="nav navbar-nav ">
         ...
         <li class="nav-item">
		  <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" class="nav-link"  >Search<span class="caret"></span></a>
		...
		<li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color:red" class="nav-link">Percentage<span class="caret"></span></a>
		 <ul class="dropdown-menu">
...
<h2 style="text-align:center;color: #ff9900"><b>ListBySubject </b></h2><hr style="width:20%; height:2px;background-color:gray">
<table align="center" style="text-align:center" border="1">
  <form id = "form" action="PercentagebyPerSubject" method="post">
 <tr>
<td>
<input id='uname' type='hidden' 
  value="<%= val.getUsername() %>" placeholder="USERNAME" name='Lname'>
</td>
</tr> 
